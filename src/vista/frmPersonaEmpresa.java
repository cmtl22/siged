...
public class frmPersonaEmpresa extends javax.swing.JInternalFrame {
...
// </editor-fold > 
    ...
    public frmPersonaEmpresa(String tipo) {
    ...
    private void btnBuscarEmpresaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarEmpresaActionPerformed
        ...
        llenarCarrera(consultarRegistroIndividual(controladorVariablesSesion.getInstance().getDatosTemporalesConsulta(), "empresa"));
