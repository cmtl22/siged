...
// </editor-fold > 
    ...
    public frmAutoridadesInstituto() {
    ...
    private void initComponents() {
        ...
        cmbTipoAutoridad = new javax.swing.JComboBox<>();
        ...
        jpRegistroUsuario.add(cmbTipoAutoridad, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 20, 230, -1));
        ...
        jpRegistroUsuario.add(lblPersona14, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 20, 10, -1));
        ...
        jpBusquedaUsuario.add(txtCriterioBusqueda, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 10, 200, -1));
    ...
    private void jtPersonaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtPersonaMouseClicked
        ...
        if (fila != -1) {
            ...
            llenarPersona(consultarRegistroIndividual(jtPersona.getValueAt(fila, 0).toString(), "autoridades"));
        }
...
// </editor-fold> 
    ...
    private boolean crearActualizar() {
        ...
        map.put("tipo", codigoTipoPersona.get(cmbTipoAutoridad.getSelectedIndex()));
    ...
    private void llenarComboTipoPersona() {
        ...
        criterioBusqueda[0] = tipoAutoridad;
        criterioBusqueda[1] = "enumeracion";//tipo de consulta
        cmbTipoAutoridad.setModel(consulta.consultarCombo(criterioBusqueda));
    ...
    private void llenarPersona(ArrayList<Object> datos) {
        ...
        cmbTipoAutoridad.setSelectedItem((String) datos.get(12));
...
// </editor-fold> 
    ...
    private javax.swing.JComboBox<String> cmbTipoAutoridad;
