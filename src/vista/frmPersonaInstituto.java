...
public class frmPersonaInstituto extends javax.swing.JInternalFrame {
    ...
    private ArrayList<Object> cargos2;
...
// </editor-fold > 
    ...
    private void initComponents() {
        ...
        jpRegistroUsuario.add(txtNombrePersona, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 130, 230, -1));
        ...
        jpRegistroUsuario.add(cmbTipoIdentificacion, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 90, -1, -1));
        ...
        jpRegistroUsuario.add(lblPersona, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 420, 10, -1));
        ...
        jpRegistroUsuario.add(lblRol, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 90, 130, -1));
        ...
        jpRegistroUsuario.add(lblClave, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 130, 130, 20));
        ...
        jpRegistroUsuario.add(lblClave3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 170, 130, 20));
        ...
        jpRegistroUsuario.add(txtApellido, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 170, 230, -1));
        ...
        jpRegistroUsuario.add(txtFormacionAcademica, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 420, 230, -1));

        lblClave5.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        lblClave5.setText("Teléfonos Fijo:");
        lblClave5.setPreferredSize(new java.awt.Dimension(120, 25));
        jpRegistroUsuario.add(lblClave5, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 250, 120, 20));
        ...
        jpRegistroUsuario.add(txtTelefonoFijo, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 250, 110, -1));
        ...
        jpRegistroUsuario.add(txtTelefonoMovil, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 250, 110, -1));
        ...
        jpRegistroUsuario.add(lblClave7, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 290, 130, 20));
        ...
        jpRegistroUsuario.add(txtEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 290, 230, -1));
        ...
        jpRegistroUsuario.add(lblClave8, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 330, 130, 20));
        ...
        jpRegistroUsuario.add(lblRol1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 370, 130, -1));
        ...
        jpRegistroUsuario.add(lblRol2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 420, 130, -1));
        ...
        jpRegistroUsuario.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 460, 230, 50));
        ...
        jpRegistroUsuario.add(txtNumeroIdentificacion, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 90, -1, -1));
        ...
        jpRegistroUsuario.add(lblPersona3, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 130, 10, -1));
        ...
        jpRegistroUsuario.add(lblPersona4, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 170, 10, -1));
        ...
        jpRegistroUsuario.add(lblPersona5, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 90, 10, -1));
        ...
        jpRegistroUsuario.add(lblPersona9, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 250, 10, -1));
        ...
        jpRegistroUsuario.add(lblPersona10, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 290, 10, -1));
        ...
        jpRegistroUsuario.add(lblPersona11, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 330, 10, -1));
        ...
        jpRegistroUsuario.add(lblPersona13, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 370, 10, -1));
        ...
        jpRegistroUsuario.add(lblTipo, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 40, 130, -1));
        ...
        jpRegistroUsuario.add(lblPersona14, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 40, 10, -1));
        ...
        jpRegistroUsuario.add(lblRol4, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 210, 130, -1));
        ...
        jpRegistroUsuario.add(cmbGenero, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 210, -1, -1));
        ...
        jpRegistroUsuario.add(lblPersona15, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 210, 10, -1));
        ...
        jtCargos.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        jtCargos.setGridColor(new java.awt.Color(0, 102, 153));
        jtCargos.setSelectionBackground(new java.awt.Color(255, 255, 0));
        jtCargos.setSelectionForeground(new java.awt.Color(0, 0, 0));
        jtCargos.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jtCargosMouseClicked(evt);
            }
        });
        jScrollPane5.setViewportView(jtCargos);

        jpRegistroUsuario.add(jScrollPane5, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 10, 230, 70));
        ...
        jpBusquedaUsuario.add(txtCriterioBusqueda, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 10, 270, -1));
    ...
    private void jtPersonaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtPersonaMouseClicked
        ...
        if (fila != -1) {
            ...
            llenarPersonalInstituto(consultarRegistroIndividual(jtPersona.getValueAt(fila, 0).toString(), "autoridades"));
        }
    ...
    private void btnCrearActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCrearActualizarActionPerformed
        if (almacenarCargos()) {
            ...
            JOptionPane.showMessageDialog(rootPane, "Debe seleccionar un cargo al menos");
        }
    ...
    private void jtCargosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtCargosMouseClicked
        int fila = jtCargos.getSelectedRow();//guarda la fila seleccionada
        accion = "actualizar";

        if (fila != -1) {
            //consulta en la base de datos y llena las cajas de texto con la consulta realizada
//            llenarRol(consultarRegistroIndividual(jtCargos.getValueAt(fila, 0).toString(), "rol"));
        }
    }//GEN-LAST:event_jtCargosMouseClicked
// </editor-fold> 
    // <editor-fold defaultstate="collapsed" desc="Metodos"> 

    private boolean almacenarCargos() {
        boolean bandera = false;
        cargos2.removeAll(cargos2);

        for (int i = 0; i < jtCargos.getRowCount(); i++) {
            if (jtCargos.getValueAt(i, 2).equals(true)) {
                cargos2.add(jtCargos.getValueAt(i, 0));
                bandera = true;
            }
        }
        return bandera;
    ...
    private void formatearColumnas() {
        ...
        jtCargos.getColumnModel().getColumn(0).setMaxWidth(0);
        jtCargos.getColumnModel().getColumn(0).setMinWidth(0);
        jtCargos.getColumnModel().getColumn(0).setPreferredWidth(0);

    }

    private void formatearColumnasCargos() {
        //Oculta la primera columna que corresponde al ID de la tabla
        jtCargos.getColumnModel().getColumn(0).setMaxWidth(0);
        jtCargos.getColumnModel().getColumn(0).setMinWidth(0);
        jtCargos.getColumnModel().getColumn(0).setPreferredWidth(0);

        jtCargos.getColumnModel().getColumn(1).setMaxWidth(300);
        jtCargos.getColumnModel().getColumn(1).setMinWidth(0);
        jtCargos.getColumnModel().getColumn(1).setPreferredWidth(250);
    ...
    private void llenarGrid() {
        jtPersona.setModel(controladorGrid.getInstance().llenarGrid("autoridades", "grid", null, true));
    ...
    private void llenarGridCargos() {
        criterioBusqueda[0] = "0";
        jtCargos.setModel(controladorGrid.getInstance().llenarGridCargos());
        formatearColumnasCargos();
    }

    private void llenarPersonalInstituto(ArrayList<Object> datos) {
        vaciarModulos();
        ...
        cmbGenero.setSelectedItem((String) datos.get(11));
        criterioBusqueda[0] = datos.get(0).toString();
        controladorConsulta consulta = new controladorConsulta();
        cargos = consulta.obtenerConsultaVarios("cargos", controladorVariablesSesion.getInstance().getFiltrar(), criterioBusqueda);

        for (int i = 0; i < jtCargos.getRowCount(); i++) {
            for (Object permiso : cargos) {
                if (jtCargos.getValueAt(i, 0).equals(permiso)) {
                    jtCargos.setValueAt(true, i, 2);
                }
            }
