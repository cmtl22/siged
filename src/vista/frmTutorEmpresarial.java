...
public class frmTutorEmpresarial extends javax.swing.JInternalFrame {
...
// </editor-fold > 
    ...
    private void initComponents() {
        ...
        setTitle("TUTOR EMPRESARIAL");
        setFrameIcon(new javax.swing.ImageIcon(getClass().getResource("/recursos/ico_tutorE_32.png"))); // NOI18N
        ...
        btnBuscarEmpresa.setToolTipText("BUSCAR");
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 943, 581));
    ...
    private void jtPersonaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtPersonaMouseClicked
        ...
        if (fila != -1) {
            ...
            llenarTutorEmpresarial(consultarRegistroIndividual(jtPersona.getValueAt(fila, 0).toString(), "tutor_empresarial"));
        }
...
// </editor-fold> 
    ...
    private void llenarGrid() {
        jtPersona.setModel(controladorGrid.getInstance().llenarGrid("tutor_empresarial", "grid", null, true));
